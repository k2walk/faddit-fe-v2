              ...
              <div className='space-y-8 mt-8'>
                ...
                <div>
                  ...
                  <div className='flex flex-wrap items-center -m-1.5'>
                    ...
                    <div className='m-1.5'>
                      {/* Start */}
                      <button className='btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-violet-500'>
                        Tertiary
                      </button>
                      {/* End */}
                    </div>
                    ...
                    <div className='m-1.5'>
                      {/* Start */}
                      <button className='btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-green-500'>
                        Success
                      </button>
                      {/* End */}
                    </div>
