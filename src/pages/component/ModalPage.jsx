                          ...
                          <div className='text-sm'>
                            ...
                            <div className='space-y-2'>
                              ...
                              <p>
                                ...
                                sit. Nec sagittis aliquam malesuada bibendum arcu vitae elementum
                                curabitur vitae. Mattis enim ut tellus elementum el fringilla est
                                ullamcorper eget nulla. Enim eu turpis egestas pretium aenean
                                pharetra magna. Aliquam id diam maecenas ultricies mi eget us mauris
                                vitae ultricies leo integer t malesuada fames ac turpis egestas
                                maecenas pharetra volutpat lacus laoreet non.
                              </p>
                              <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                eiusmod tempor incididunt ut labore et dolore magna aliqua.
                      ...
                      >
                        ...
                        <div className='text-sm mb-5'>
                          ...
                          <div className='text-xs text-gray-500'>
                            ...
                            . You can stop it at any time on the integrations page of your Mosaic
                            account.
                          </div>
                        </div>
                        {/* Modal footer */}
                      ...
                      >
                        ...
                        <div className='p-5'>
                          ...
                          <div className='text-sm mb-5'>
                            <div className='space-y-2'>
                              <p>
                                You might not be aware of this fact, but every frame, digital video,
                                canvas, responsive design, and image often has a rectangular shape
                                that is exceptionally precise in proportion (or ratio).
                              </p>
                              <p>
                                The ratio has to be well-defined to make shapes fit into different
                                and distinct mediums, such as computer, movies, television and
                                camera screens.
                              </p>
                            </div>
                          </div>
                      ...
                      >
                        ...
                        <div className='px-5 pt-4 pb-1'>
                          <div className='text-sm'>
                                  ...
                                  <div className='flex items-center'>
                                    ...
                                    <div className='grow'>
                                      <div className='flex flex-wrap items-center justify-between mb-0.5'>
                                        ...
                                        <span className='text-gray-600'>
                                          <span className='font-medium text-green-600'>$59.00</span>
                                          /mo
                                        </span>
                                      </div>
                                      <div className='text-sm'>
                                  ...
                                  <div className='flex items-center'>
                                    ...
                                    <div className='grow'>
                                      <div className='flex flex-wrap items-center justify-between mb-0.5'>
                                        ...
                                        <span className='text-gray-600'>
                                          <span className='font-medium text-green-600'>$79.00</span>
                                          /mo
                                        </span>
                                      </div>
                                      <div className='text-sm'>
                            ...
                            <div className='text-xs text-gray-500'>
                              Your workspace’s Mosaic Light Plan is set to $39 per month and will
                              renew on August 9, 2024.
                            </div>
                          </div>
                        </div>
                        {/* Modal footer */}
