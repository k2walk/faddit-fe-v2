              ...
              <div className='space-y-8 mt-8'>
                ...
                <div>
                  ...
                  <div className='flex flex-wrap items-center -m-1.5'>
                    ...
                    <div className='m-1.5'>
                      {/* Start */}
                      <div className='text-xs inline-flex font-medium bg-sky-500/20 text-sky-700 rounded-full text-center px-2.5 py-1'>
                        Exciting news
                      </div>
                      {/* End */}
                    </div>
                    ...
                    <div className='m-1.5'>
                      {/* Start */}
                      <div className='text-xs inline-flex font-medium bg-red-500/20 text-red-700 rounded-full text-center px-2.5 py-1'>
                        Bug Fix
                      </div>
                      {/* End */}
                    </div>
                    ...
                    <div className='m-1.5'>
                      {/* Start */}
                      <div className='text-xs inline-flex font-medium bg-gray-700 text-gray-100 dark:bg-gray-200 dark:text-gray-600 rounded-full text-center px-2.5 py-1'>
                        All Stories
                      </div>
                      {/* End */}
                    </div>
                ...
                <div>
                  ...
                  <div className='flex flex-wrap items-center -m-1.5'>
                    <div className='m-1.5'>
                      {/* Start */}
                      <div className='text-sm inline-flex font-medium bg-violet-500/20 text-violet-600 rounded-full text-center px-2.5 py-1'>
                        Working on
                      </div>
                      {/* End */}
                    </div>
                    <div className='m-1.5'>
                      {/* Start */}
                      <div className='text-sm inline-flex font-medium bg-sky-500/20 text-sky-700 rounded-full text-center px-2.5 py-1'>
                        Exciting news
                      </div>
                      {/* End */}
                    </div>
                    <div className='m-1.5'>
                      {/* Start */}
                      <div className='text-sm inline-flex font-medium bg-green-500/20 text-green-700 rounded-full text-center px-2.5 py-1'>
                        Product
                      </div>
                      {/* End */}
                    </div>
                    <div className='m-1.5'>
                      {/* Start */}
                      <div className='text-sm inline-flex font-medium bg-yellow-500/20 text-yellow-700 rounded-full text-center px-2.5 py-1'>
                        Announcement
                      </div>
                      {/* End */}
                    </div>
                    <div className='m-1.5'>
                      {/* Start */}
                      <div className='text-sm inline-flex font-medium bg-red-500/20 text-red-700 rounded-full text-center px-2.5 py-1'>
                        Bug Fix
                      </div>
                      {/* End */}
                    </div>
                    <div className='m-1.5'>
                      {/* Start */}
                      <div className='text-sm inline-flex font-medium bg-blue-500/20 text-blue-600 rounded-full text-center px-2.5 py-1'>
                        Customer Stories
                      </div>
                      {/* End */}
                    </div>
                    ...
                    <div className='m-1.5'>
                      {/* Start */}
                      <div className='text-sm inline-flex font-medium bg-gray-700 text-gray-100 dark:bg-gray-200 dark:text-gray-600 rounded-full text-center px-2.5 py-1'>
                        All Stories
                      </div>
                      {/* End */}
                    </div>
