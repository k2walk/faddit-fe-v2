                ...
                <div className='grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-4'>
                  ...
                  <div className='flex shrink-0 -space-x-3 -ml-px'>
                    <a className='block' href='#0'>
                      <img
                        className='rounded-full border-2 border-gray-100 dark:border-gray-900 box-content'
                        src={UserImage08}
                        width='32'
                        height='32'
                        alt='User 08'
              ...
              <div className='space-y-6'>
                ...
                <div>
                  ...
                  <div className='space-y-2'>
                    {/* Task */}
                    <div
                      className='bg-white dark:bg-gray-800 shadow-xs rounded-xl p-4'
                      draggable='true'
                    >
                        ...
                        <div className='grow mt-0.5 mb-3 sm:mb-0 space-y-3'>
                          <div className='flex items-center'>
                            ...
                            <label className='flex items-center'>
                              ...
                              />
                              <span className='font-medium text-gray-800 dark:text-gray-100 peer-checked:line-through ml-2'>
                            ...
                            <li>
                              <label className='flex items-center'>
                                <input
                                  ...
                                  defaultChecked
                                />
                                <span className='text-sm text-gray-800 dark:text-gray-100 peer-checked:line-through ml-3'>
                ...
                <div>
                  ...
                  <div className='space-y-2'>
                    {/* Task */}
                    <div
                      className='bg-white dark:bg-gray-800 shadow-xs rounded-xl p-4 opacity-60'
                      draggable='true'
                    >
                      <div className='sm:flex sm:justify-between sm:items-start'>
                        {/* Left side */}
