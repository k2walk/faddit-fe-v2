                ...
                <article className='pt-6'>
                  <div className='xl:flex'>
                    <div className='w-32 shrink-0'>
                      <div className='text-xs font-semibold uppercase text-gray-400 dark:text-gray-500 xl:leading-8'>
                        8 July, 2024
                      </div>
                    </div>
                    <div className='grow pb-6 border-b border-gray-200 dark:border-gray-700/60'>
                      <header>
                        <h2 className='text-2xl text-gray-800 dark:text-gray-100 font-bold mb-3'>
