              ...
              <div className='lg:max-w-[640px] lg:mx-auto'>
                ...
                <div className='mb-6 lg:mb-0'>
                  ...
                  <header className='mb-6'>
                    ...
                    <p>
                      You will soon receive a confirmation email with details of your order and a
                    ...
                    <div className='space-y-6'>
                        ...
                        <div className='text-sm rounded-sm border border-gray-200 dark:border-gray-700/60 p-3'>
                          <div className='flex items-center justify-between space-x-2'>
                            ...
                            <div className='flex items-center'>
                              ...
                              <div>
                                Ending with{' '}
                                <span className='text-gray-800 dark:text-gray-100'>2478</span>
                              </div>
                            </div>
                            {/* Expiry */}
                      ...
                      <div className='mt-6'>
                        ...
                        <div className='text-xs text-gray-500 italic text-center'>
                          Should you ever change your mind, we offer a 14-day, no-questions-asked
                          refund policy.
                        </div>
                      </div>
                    </div>
