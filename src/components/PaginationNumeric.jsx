    ...
    <div className='flex justify-center'>
      <nav className='flex' role='navigation' aria-label='Navigation'>
        ...
        <ul className='inline-flex text-sm font-medium -space-x-px rounded-lg shadow-xs'>
          <li>
            <span className='inline-flex items-center justify-center rounded-l-lg leading-5 px-3.5 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 text-violet-500'>
              1
            </span>
          </li>
          <li>
          ...
          <li>
            <a
              className='inline-flex items-center justify-center rounded-r-lg leading-5 px-3.5 py-2 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900 border border-gray-200 dark:border-gray-700/60 text-gray-600 dark:text-gray-300'
              href='#0'
            >
              9
            </a>
        ...
        <div className='ml-2'>
          <a
            href='#0'
            className='inline-flex items-center justify-center rounded-lg leading-5 px-2.5 py-2 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900 border border-gray-200 dark:border-gray-700/60 text-violet-500 shadow-xs'
          >
