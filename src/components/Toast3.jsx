    ...
    <>
      {open && (
        <div className={className} role='alert'>
          <div className='inline-flex min-w-[20rem] px-4 py-2 rounded-lg text-sm bg-white dark:bg-gray-800 shadow-xs border border-gray-200 dark:border-gray-700/60 text-gray-600 dark:text-gray-100'>
