        ...
        <div className='grow flex flex-col p-5'>
          ...
          <div className='grow'>
            ...
            <div className='flex items-center space-x-2 mb-4'>
              <div className='inline-flex text-sm font-medium bg-green-500/20 text-green-700 rounded-full text-center px-2.5 py-0.5'>
                {props.deal}
              </div>
              <div className='inline-flex text-sm font-medium text-gray-400 dark:text-gray-500 line-through'>
                {props.price}
              </div>
            </div>
          </div>
