            ...
            <div className='flex items-center space-x-2 mb-4'>
              ...
              <div className='flex space-x-1'>
                <button>
                  ...
                  <svg
                    className={`fill-current ${Math.round(props.rating) > 0 ? 'text-yellow-500' : 'text-gray-300'}`}
                    width='16'
                    height='16'
                    viewBox='0 0 16 16'
                  >
                ...
                <button>
                  ...
                  <svg
                    className={`fill-current ${Math.round(props.rating) > 1 ? 'text-yellow-500' : 'text-gray-300'}`}
                    width='16'
                    height='16'
                    viewBox='0 0 16 16'
                  >
                ...
                <button>
                  ...
                  <svg
                    className={`fill-current ${Math.round(props.rating) > 2 ? 'text-yellow-500' : 'text-gray-300'}`}
                    width='16'
                    height='16'
                    viewBox='0 0 16 16'
                  >
                ...
                <button>
                  ...
                  <svg
                    className={`fill-current ${Math.round(props.rating) > 3 ? 'text-yellow-500' : 'text-gray-300'}`}
                    width='16'
                    height='16'
                    viewBox='0 0 16 16'
                  >
                ...
                <button>
                  ...
                  <svg
                    className={`fill-current ${Math.round(props.rating) > 4 ? 'text-yellow-500' : 'text-gray-300'}`}
                    width='16'
                    height='16'
                    viewBox='0 0 16 16'
                  >
              ...
              {/* Rate */}
              <div className='inline-flex text-sm font-medium bg-yellow-500/20 text-yellow-700 rounded-full text-center px-2.5 py-0.5'>
                {props.rating}
              </div>
            </div>
            {/* Features list */}
