...
function ShopCards07() {
  return (
    <React.Fragment>
      {/* Card 1 */}
      <div className='col-span-full md:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl overflow-hidden'>
        <div className='flex flex-col h-full'>
          ...
          <div className='grow flex flex-col p-5'>
            ...
            <div className='flex flex-wrap justify-between items-center'>
              ...
              {/* Price */}
              <div>
                <div className='inline-flex text-sm font-medium bg-red-500/20 text-red-700 rounded-full text-center px-2 py-0.5'>
                  $39.00
                </div>
              </div>
            </div>
        ...
        <div className='h-full p-6 bg-gray-900 dark:bg-gray-800 rounded-lg text-center xl:text-left xl:flex xl:justify-between xl:items-center'>
          <div className='mb-4 xl:mb-0 xl:mr-4'>
            ...
            <div className='m-auto text-sm text-gray-400'>
              Excepteur sint occaecat cupidatat non proidentsunt in culpa qui officia deserunt
              mollit!
            </div>
          </div>
          <button className='btn bg-gray-100 text-gray-800 hover:bg-white shrink-0'>
            Reedem Now!
          </button>
        </div>
      </div>
