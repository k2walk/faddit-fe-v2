...
function ShopCards06() {
  return (
    <React.Fragment>
      {/* Card 1 */}
      <div className='relative col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-gray-800 shadow-xs rounded-xl overflow-hidden'>
        {/* Image */}
        <img
        ...
        {/* Gradient */}
        <div
          className='absolute inset-0 bg-linear-to-t from-gray-800 to-transparent'
          aria-hidden='true'
        ></div>
        {/* Content */}
