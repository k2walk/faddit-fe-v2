        ...
        <div className='grow'>
          <div className='sm:flex items-start justify-between mb-0.5'>
            ...
            <div className='xl:flex items-center mb-2 sm:mb-0'>
              <button
                className='text-sm font-semibold text-gray-800 dark:text-gray-100 text-left truncate'
              ...
              {open && (
                <>
                  <div className='text-sm text-gray-400 dark:text-gray-600 hidden xl:block mx-1'>
                    ·
                  </div>
            ...
            {/* Date */}
            <div className='text-xs font-medium text-gray-500 whitespace-nowrap mb-2 sm:mb-0'>
              {props.date}
            </div>
          </div>
          {/* To */}
