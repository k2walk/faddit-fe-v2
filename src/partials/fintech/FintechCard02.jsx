...
function FintechCard02() {
  return (
    <div className='flex flex-col col-span-full xl:col-span-4 bg-linear-[225deg,var(--color-gray-800),var(--color-gray-900)] from-gray-800 to-gray-900 shadow-xs rounded-xl'>
