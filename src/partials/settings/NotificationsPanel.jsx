        ...
        <section>
          ...
          <ul>
            <li className='flex justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700/60'>
              ...
              {/* Right */}
              <div className='flex items-center ml-4'>
                <button className='btn-sm border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-xs'>
                  Manage
                </button>
              </div>
            </li>
            ...
            <li className='flex justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700/60'>
              ...
              <div className='flex items-center ml-4'>
                ...
                <button className='btn-sm border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-xs text-red-500'>
                  Disable
                </button>
              </div>
            </li>
