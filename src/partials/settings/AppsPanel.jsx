      ...
      <div className='p-6'>
        ...
        <section className='pb-6 border-b border-gray-200 dark:border-gray-700/60'>
          <div className='grid grid-cols-12 gap-6'>
            {/* Card 1 */}
            <div className='col-span-full xl:col-span-6 2xl:col-span-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-xs rounded-lg'>
              {/* Card content */}
              <div className='flex flex-col h-full p-5'>
                ...
                <footer className='mt-4'>
                  <div className='flex flex-wrap justify-between items-center'>
                    ...
                    {/* Right side */}
                    <button className='btn-sm border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-xs flex items-center'>
                      <svg
        ...
        <section>
          ...
          <div className='grid grid-cols-12 gap-6'>
            {/* Card 1 */}
            <div className='col-span-full xl:col-span-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-xs rounded-lg'>
              {/* Card content */}
              <div className='flex flex-col h-full p-5'>
                <div className='grow'>
                  <header>
