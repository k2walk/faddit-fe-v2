        ...
        <section>
          <div className='mb-8'>
            ...
            <div className='text-sm'>
              This workspace’s Basic Plan is set to <strong className='font-medium'>$34</strong> per
              month and will renew on <strong className='font-medium'>July 9, 2024</strong>.
            </div>
          </div>
            ...
            <div className='grid grid-cols-12 gap-6'>
              ...
              <div className='relative col-span-full xl:col-span-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-xs rounded-b-lg'>
                ...
                <div className='px-5 pt-5 pb-6 border-b border-gray-200 dark:border-gray-700/60'>
                  ...
                  {/* CTA */}
                  <button className='btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white w-full'>
                    Upgrade
                  </button>
                </div>
                <div className='px-5 pt-4 pb-5'>
        ...
        <section>
          ...
          <ul className='space-y-5'>
            ...
            <li>
              ...
              <div className='text-sm'>
                Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt
                mollit anim id est laborum in voluptate velit esse cillum dolore eu fugiat nulla
                pariatur.
              </div>
            </li>
            <li>
              ...
              <div className='text-sm'>
                Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt
                mollit anim id est laborum in voluptate velit esse cillum dolore eu fugiat{' '}
                <a
