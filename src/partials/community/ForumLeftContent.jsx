            ...
            <div>
              ...
              <ul className='flex flex-nowrap md:block mr-3 md:mr-0'>
                <li className='mr-0.5 md:mr-0 md:mb-0.5'>
                  ...
                  >
                    <svg
                      className='w-3 h-3 shrink-0 fill-current text-green-500 mr-3'
                      viewBox='0 0 12 12'
                    >
                ...
                <li className='mr-0.5 md:mr-0 md:mb-0.5'>
                  ...
                  >
                    <svg
                      className='w-3 h-3 shrink-0 fill-current text-red-500 mr-3'
                      viewBox='0 0 12 12'
                    >
                      <path d='M6 10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0 2A6 6 0 1 1 6 0a6 6 0 0 1 0 12Z' />
                    </svg>
                ...
                <li className='mr-0.5 md:mr-0 md:mb-0.5'>
                  ...
                  >
                    <svg
                      className='w-3 h-3 shrink-0 fill-current text-yellow-500 mr-3'
                      viewBox='0 0 12 12'
                    >
                      <path d='M6 10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0 2A6 6 0 1 1 6 0a6 6 0 0 1 0 12Z' />
                    </svg>
