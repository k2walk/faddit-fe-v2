...
function ForumEntry() {
  return (
    <article className='bg-white dark:bg-gray-800 shadow-xs rounded-xl p-5'>
      {/* Breadcrumbs */}
      <div className='mb-2'>
        <ul className='inline-flex flex-wrap text-sm font-medium'>
          <li className='flex items-center'>
            ...
            <svg
              className='fill-current text-gray-400 dark:text-gray-500 mx-2'
              width='16'
              height='16'
              viewBox='0 0 16 16'
            >
      ...
      <div className='space-y-4 mb-6'>
        <p>
          Looking for new ideas to get users, receive feedback, and increase exposure! Besides PH,
          where else do you showcase your product?
        </p>
        <p>Please advise 🙌</p>
      </div>
      {/* Comment form */}
            ...
            <div className='flex items-start'>
              ...
              <div>
                ...
                <div className='grow text-sm text-gray-800 dark:text-gray-100 space-y-2 mb-2'>
                  <p>
                    We've also had the same question to be honest. And for Appy.com launch we
                    decided to go with Twitter as a primary medium and then Product Hunt as the
                    other one. And I have to say that it led to some great results as Twitter allows
                    you to be super active and engage in many conversations.
                  </p>
                  <p>
                    Also, users are there and everything is super active. So that will be my advice
          ...
          <li className='relative pl-9 space-y-5'>
            ...
            <div className='flex items-start'>
              ...
              <div>
                ...
                <div className='grow text-sm text-gray-800 dark:text-gray-100 space-y-2 mb-2'>
                  <p>
                    If you are a SaaS product and are looking for early adopters, AppSumo seems to
                    be a great place to list on. Most of the users there seem to be early-adopters.
                    Life-time deals seem to be the norm there.
                  </p>
                </div>
                {/* Comment footer */}
                <div className='flex flex-wrap text-xs'>
          ...
          <li className='relative pl-9 space-y-5'>
            ...
            <div className='flex items-start'>
              ...
              <div>
                ...
                <div className='grow text-sm text-gray-800 dark:text-gray-100 space-y-2 mb-2'>
                  <p>
                    Thank you very much for all the people who are posting other alternatives! I
                    will launch my free product design course in February and I will make a notion
              ...
              <li className='relative pl-9 space-y-5'>
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <div className='grow text-sm text-gray-800 dark:text-gray-100 space-y-2 mb-2'>
                      <p>
                        That sounds like an excellent idea. I'd love to take a look when you're
                        ready!
                      </p>
                    </div>
                    {/* Comment footer */}
