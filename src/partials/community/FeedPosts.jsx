    ...
    <>
      ...
      <div className='bg-white dark:bg-gray-800 shadow-xs rounded-xl p-5'>
        ...
        <div className='text-sm text-gray-800 dark:text-gray-100 space-y-2 mb-5'>
          <p>👋</p>
          <p>
            It's more likely that people reading your blog will opt in with their email addresses if
            you give them something highly relevant in return. Ditch that too-general lead magnet
            and create "content upgrades" for your highest-traffic articles.
          </p>
          <p>Thread 👇</p>
        </div>
        {/* Footer */}
            ...
            <li className='p-3 bg-gray-50 dark:bg-gray-700/30 rounded-sm'>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <div className='text-sm'>
                    Depends on the company you're running, but if I had to choose just one book,
                    it'd be The Personal MBA by Josh Kaufman.
                  </div>
                </div>
              </div>
            </li>
          ...
          <div className='relative flex items-center justify-center my-4!'>
            ...
            <div className='absolute left-4 bottom-4 right-4'>
              <div className='flex items-center space-x-1'>
                ...
                <div className='text-xs font-medium text-gray-300 px-2 py-1 bg-black/25'>
                  1M Views
                </div>
              </div>
            </div>
