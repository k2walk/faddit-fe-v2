        ...
        <div className='-mt-16 mb-6 sm:mb-3'>
          <div className='flex flex-col items-center sm:flex-row sm:justify-between sm:items-end'>
            ...
            <div className='flex space-x-2 sm:mb-2'>
              <button className='p-1.5 shrink-0 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-xs'>
          ...
          <div className='flex-1 space-y-5 mb-8 xl:mb-0'>
            ...
            <div>
              ...
              <div className='grid xl:grid-cols-2 gap-4'>
                {/* Card */}
                <div className='bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-xs'>
                  {/* Card header */}
                  ...
                  <li className='sm:flex sm:items-center sm:justify-between'>
                    ...
                    <div className='sm:ml-2 mt-2 sm:mt-0'>
                      <ul className='flex flex-wrap sm:justify-end -m-1'>
                        <li className='m-1'>
                          <button className='inline-flex items-center justify-center text-xs font-medium leading-5 rounded-full px-2.5 py-0.5 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-xs bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 transition'>
                            Marketing
                          </button>
                        </li>
                        <li className='m-1'>
