    ...
    <div className={`bg-white dark:bg-gray-800 shadow-xs rounded-xl px-5 py-4`}>
      <div className='md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2'>
        ...
        <div className='flex items-center space-x-4 pl-10 md:pl-0'>
          <div className='text-sm text-gray-500 dark:text-gray-400 italic whitespace-nowrap'>
            {props.date}
          </div>
          {props.type && (
            <div
          ...
          <button
            className={`${props.fav ? 'text-yellow-500' : 'text-gray-300 dark:text-gray-600 hover:text-gray-400 dark:hover:text-gray-500'}`}
          >
