          ...
          <div className='max-w-sm mx-auto lg:max-w-none'>
            ...
            <div className='drop-shadow-md mt-12'>
              ...
              <div className='flex justify-between items-center' aria-hidden='true'>
                ...
                <svg
                  className='fill-white dark:fill-gray-800 rotate-180'
                  width='20'
                  height='20'
                  xmlns='http://www.w3.org/2000/svg'
                >
              ...
              <div className='bg-white dark:bg-gray-800 rounded-b-xl p-5 pt-2.5 text-sm space-y-3'>
                <div className='flex justify-between space-x-1'>
                  ...
                  <span className='font-medium text-gray-700 dark:text-gray-100 text-right'>
            ...
            <div className='flex items-center space-x-3 mt-6'>
              <div className='w-1/2'>
                <button className='btn w-full border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300'>
                  <svg
                    className='fill-current text-gray-400 dark:text-gray-500 shrink-0 rotate-180'
                    width='16'
                    height='16'
                    viewBox='0 0 16 16'
                    xmlns='http://www.w3.org/2000/svg'
